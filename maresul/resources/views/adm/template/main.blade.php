...
<body>
    ...
    <div id="app">
        ...
        <nav class="navbar navbar-expand-md navbar-dark sticky-top flex-md-nowrap" style="background-color:black">
            <a class="navbar-brand" href="#">MAR AZUL - Admin</a>
        ...
        <nav class=" navbar col-md-2 d-none d-md-block  bg-dark sidebar text-white" id="nav1" style= "position:fixed; left: 0; height: 100%">
            ...
            <ul class="nav flex-column mb-2">
                ...
                <li class="nav-item">
                <a id="forum" class="nav-link" href="/forum" data-toggle="tooltip" data-placement="right" title="interações da comunidade"><i class="fa fa-quote-left"></i> Fórum Virtual</a>
                </li>
                <li class="nav-item">
                <a id="mural" class="nav-link" href="/recados" data-toggle="tooltip" data-placement="right" title="recados pessoais dos moradores"><i class="fa fa-clipboard-list"></i> Mural</a>
                </li>
            </ul>
            </div>
        </nav>
