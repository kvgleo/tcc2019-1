    ...
    <div class="card col-md-12 " style="margin-bottom:20px; float:left; background:none; border:none;">
        <div class="card alert-secondary" style="margin-bottom:20px;">
            <div class="card-body">
                ...
                <h4 class="card-text"> Sem Registros no Histórico! </h4>
                <hr>
                <p class="card-text"> Não foi encontrado nada no histórico, adicione lançamentos na aba despesas para ver o histórico atual clicando <a href="/despesas" class="alert-link">aqui</a></p>
            </div>
        </div>
    </div>
