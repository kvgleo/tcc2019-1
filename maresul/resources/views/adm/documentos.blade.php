...
@section('main-content')
    ...
    @endif
        ...
        <div class="card col-md-6 " style="margin-bottom:20px; border:none; background:none; float:left; max-height:520px; margin-right:30px; overflow-y: auto; ">
          <div class="card-body">
            <div class="row">
              <div class="col-12">
                <div class="list-group" id="listinha" role="tablist">
                    @foreach($docs as $d)
                        <a class="list-group-item  list-group-item-action">{{$d->doc_title}}<button type="button" class="btn btn-danger"style="float:right" onclick="see('{{$d->id}}')" ><i class="fa fa-arrow-right" ></i></button></a>
                    @endforeach
                </div>
              </div>
            </div>
        ...
        <div id="info_view">
            @foreach($docs as $d)
            <div class="card col-md-5 infos" style="margin-bottom:20px; display:none;" id="{{$d->id}}">
                <div class="card-body">
